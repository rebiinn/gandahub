    ...
    <div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-16 lg:py-24">
          <div className="grid lg:grid-cols-2 gap-6 sm:gap-8 items-center">
            <div className="text-center lg:text-left">
              ...
              <h1 className="text-3xl sm:text-4xl lg:text-6xl font-display font-bold text-gray-800 mb-3 sm:mb-4">
                Discover Your
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-3 sm:gap-4">
              {categories.slice(0, 6).map((category) => (
                <Link
                  ...
                  className="group"
                >
                  <div className="bg-white rounded-xl p-4 sm:p-6 text-center shadow-sm hover:shadow-lg transition-all duration-300 group-hover:-translate-y-1">
        ...
        <section className="py-12 sm:py-16">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between mb-7 sm:mb-10">
              ...
              <Link to="/products?featured=true" className="text-primary-600 hover:text-primary-700 text-sm sm:text-base font-medium flex items-center gap-1.5 sm:gap-2">
                View All
                <FaArrowRight />
              </Link>
            </div>
      ...
      <section className="py-12 sm:py-16 bg-gradient-to-r from-primary-600 to-secondary-500">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-5xl font-display font-bold text-white mb-3 sm:mb-4">
            Up to 50% Off Sale
          </h2>
        ...
        <section className="py-12 sm:py-16 bg-gray-50">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between mb-7 sm:mb-10">
              ...
              <Link to="/products?sort_by=created_at" className="text-primary-600 hover:text-primary-700 text-sm sm:text-base font-medium flex items-center gap-1.5 sm:gap-2">
                View All
                <FaArrowRight />
              </Link>
            </div>
        ...
        <section className="py-12 sm:py-16 bg-white">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="flex items-center justify-between mb-7 sm:mb-10">
              ...
              <Link to="/products?on_sale=true" className="text-primary-600 hover:text-primary-700 text-sm sm:text-base font-medium flex items-center gap-1.5 sm:gap-2">
                View All
                <FaArrowRight />
              </Link>
            </div>
      ...
      {/* Newsletter CTA */}
      <section className="py-12 sm:py-16 bg-cosmetic-champagne">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl sm:text-3xl font-display font-bold text-gray-800 mb-3 sm:mb-4">
